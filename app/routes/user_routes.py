...
from ..controllers.user_controller import (create_user, delete_user,
...
@router.get("/users/{user_id}", response_model=UserCreate, dependencies=[Depends(auth_middleware)])
...
@router.put("/users/{user_id}", response_model=UserCreate, dependencies=[Depends(auth_middleware)])
